...
/**
 * The {@link org.apache.commons.io.input.ObservableInputStream} allows, that an InputStream may be consumed
 * by other receivers, apart from the thread, which is reading it.
 * The other consumers are implemented as instances of {@link org.apache.commons.io.input.ObservableInputStream.Observer}. A
 * typical application may be the generation of a {@link java.security.MessageDigest} on the
 * fly.
 * {@code Note}: The {@link org.apache.commons.io.input.ObservableInputStream} is <em>not</em> thread safe,
...
/**
 * copied and modified the {@link org.apache.commons.io.input.ObservableInputStream} by jibum.jung@gmail.com
 * because of Observer's method signature.
 *
 * It will be removed when commons-io.2.7 is released.
 */
public class DoorayObservableInputStream extends ProxyInputStream {
     ...
     */
    public DoorayObservableInputStream(final InputStream pProxy) {
        super(pProxy);
    }
     ...
     */
    public void remove(final org.apache.commons.io.input.ObservableInputStream.Observer pObserver) {
    ...
    /**
     * Notifies the observers by invoking {@link org.apache.commons.io.input.ObservableInputStream.Observer#data(byte[], int, int)}
    ...
    /**
     * Notifies the observers by invoking {@link org.apache.commons.io.input.ObservableInputStream.Observer#finished()}.
     *
     * @throws IOException Some observer has thrown an exception, which is being
     *                     passed down.
     */
    ...
    /**
     * Notifies the observers by invoking {@link org.apache.commons.io.input.ObservableInputStream.Observer#data(int)}
     * with the given arguments.
     *
    ...
    /**
     * Notifies the observers by invoking {@link org.apache.commons.io.input.ObservableInputStream.Observer#error(IOException)}
    ...
    public static abstract class Observer {
         ...
         * on the {@link org.apache.commons.io.input.ObservableInputStream}, and will return a value.
         *
        ...
        /**
         * Called to indicate, that the {@link org.apache.commons.io.input.ObservableInputStream} has been closed.
         *
         * @throws IOException if an i/o-error occurs
         */
